    ...
    <section class="checkout pt-100">
      <div class="container">
        <div class="row">
            ...
            <div class="checkout-payment-method mt-50">
              ...
              <div id="checkout_accordion_1">
                ...
                <div class="card">
                  ...
                  <h5 class="collapsed card-title d-flex" data-bs-toggle="collapse" data-bs-target="#faq-item-2-1" aria-expanded="false">
                ...
                <!-- card -->
                <div class="card">
                  <h5 class="card-title d-flex" data-bs-toggle="collapse" data-bs-target="#faq-item-2-2" aria-expanded="true">
                    <i data-feather="circle"></i>
                    <i class="fa-solid fa-circle"></i>
                    Cash on delivery <img class="img-fluid" src="./images/taka.png" alt="#">
                  </h5>
                ...
                <!-- card -->
                <div class="card">
                  <h5 class="collapsed card-title d-flex" data-bs-toggle="collapse" data-bs-target="#faq-item-2-3" aria-expanded="false">
                    <i data-feather="circle"></i>
                    Mobile Banking <img src="images/bKash.png" alt="#"><img src="images/nagad.png" alt="#"><img src="images/rocket.PNG" alt="#">
                  </h5>
                ...
                <!-- card -->
                <div class="card">
                  <h5 class="collapsed card-title d-flex" data-bs-toggle="collapse" data-bs-target="#faq-item-2-4" aria-expanded="false">
                    <i data-feather="circle"></i>
                    Bank <img src="images/banking.png" alt="#">
                  </h5>
          ...
          <div class="offset-lg-2 col-lg-4 mt-50">
            <div class="title2">
              <h2>Your order</h2>
            </div>
